...
router.post('/category/:categoryId', deviceController.addInfo);
...
router.put('/category/:categoryId', deviceController.updateCategoryTitle);

router.delete('/:id', deviceController.remove);
router.delete('/category/:categoryId', deviceController.removeCategory);
